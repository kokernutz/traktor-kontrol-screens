 ...
 // BOTTOM RIGHT
  ...
  Item {
    ...
    Rectangle {
      ...
      anchors.top: parent.top
      anchors.right: parent.right
      color: headerPropertyLoopActive.value ? colors.colorGreen50 : colors.colorGrey40 // deckRunning.value && isMaster ? colors.colorDeckBlueBright : colors.colorGrey40

      Text {
        anchors.fill: parent
        text: "LOOP "  + loopText[loopSizePos]
        color: headerPropertyLoopActive.value ? colors.colorGrey40 : colors.colorGreen50 // isMaster ? (deckRunning.value ? colors.colorGrey24 : colors.colorDeckBlueBright) : colors.colorGrey200
        font.family: "Pragmatica" //MediumTT"
        font.pixelSize: fonts.smallFontSize + 1
        horizontalAlignment: Text.AlignHCenter
        verticalAlignment: Text.AlignVCenter
