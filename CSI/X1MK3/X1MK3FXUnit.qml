...
Module
{
  ...
  WiresGroup
  {
    enabled: module.active && (module.layer == FXSectionLayer.mixer)

    Wire { from: "softtakeover1.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels." + module.deckIdx + ".eq.high"; ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    Wire { from: "softtakeover2.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels." + module.deckIdx + ".eq.mid";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    Wire { from: "softtakeover3.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels." + module.deckIdx + ".eq.low";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }
    Wire { from: "softtakeover4.output"; to: ValuePropertyAdapter { path: "app.traktor.mixer.channels." + module.deckIdx + ".volume";  ignoreEvents: PinEvent.WireEnabled | PinEvent.WireDisabled } }

    Wire { from: "%surface%.buttons.1"; to: TogglePropertyAdapter { path: "app.traktor.mixer.channels." + module.deckIdx + ".eq.kill_high"; color: Color.Blue } }
    Wire { from: "%surface%.buttons.2"; to: TogglePropertyAdapter { path: "app.traktor.mixer.channels." + module.deckIdx + ".eq.kill_mid";  color: Color.Blue } }
    Wire { from: "%surface%.buttons.3"; to: TogglePropertyAdapter { path: "app.traktor.mixer.channels." + module.deckIdx + ".eq.kill_low";  color: Color.Blue } }
    Wire { from: "%surface%.buttons.4"; to: TogglePropertyAdapter { path: "app.traktor.mixer.channels." + module.deckIdx + ".cue";          color: Color.Blue } }
  }
}
